namespace ex19_asyncs
{
    public partial class FrmMain : Form
    {
        ...
        // 이벤트핸들러. 비동기화복사 진행
        // void는 리턴값이 없으므로 Task<void> 없음. 그냥 void..
        ...
        long CopySync(string srcPath, string destPath)
        {
            ...
            // File은 Open()하면 반드시 Close() 해야 함. using()을 쓰면 Close() C#이 알아서 해줌
            // 파일입출력
        ...
        // async 나는 비동기메소드야라고 정의.
        // await 비동기메소드가 끝날때까지 기다릴게라는 정의
        // 비동기를 처리하는 메소드명 ...Async()로 끝남
        // async는 메소드 리턴값에 작성. 리턴값은 Task<리턴값>
